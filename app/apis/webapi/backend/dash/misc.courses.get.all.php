...
*/
	...
	$res_courses = db_query("SELECT course.* FROM course INNER JOIN course_meta AS meta ON meta.course_id = course.id WHERE meta.category = 'others' ORDER BY course_id ASC;");
	// $courses = array();
