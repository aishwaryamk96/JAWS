...
*/
	...
	$voucher_awarded_date = date('Y-m-d H:i:s');
	db_exec("UPDATE refer SET status='voucher_awarded', voucher_awarded_date = '".$voucher_awarded_date."' WHERE email='".$refer_data['email']."' ");
	// send mail of voucher confirmation

	send_email("referral.voucher.notify", array("to" => (($GLOBALS["jaws_exec_live"]) ? $refer_data["ref_email"] : "nikita@jigsawacademy.com"), "cc"=>"jagruti@jigsawacademy.com" ,"subject" => "Confirmation on your Amazon Voucher"), array('referrer_name' => $refer_data['ref_name']));
