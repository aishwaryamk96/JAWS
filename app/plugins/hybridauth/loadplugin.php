...
*/
    ...
    function soc_get_info($provider, $initsession = true, $reauth = false) {
		...
		"providers" => array(
			...
			"LinkedIn" => array(
				"enabled" => true,
				"keys" => array("id" => ($GLOBALS['jaws_exec_live'] ? JAWS_AUTH_SOCIAL_LI_ID : JAWS_AUTH_SOCIAL_LI_ID_TEST), "secret" => ($GLOBALS['jaws_exec_live'] ? JAWS_AUTH_SOCIAL_LI_KEY : JAWS_AUTH_SOCIAL_LI_KEY_TEST))
			)
		),
		"debug_mode" => true,
		"debug_file" => "external/temp/hybridauth.log",
	);
