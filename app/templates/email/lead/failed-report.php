...
<head>
    ...
    <title>Your enquiry has been registered - Jigsaw Academy</title>
</head>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td style="padding-left: 12px; padding-right: 12px;">
                                                                                                                        <table border="0" cellpadding="0" cellspacing="0" class="basetable" width="100%" align="center" style="border: none; border-collapse: collapse; border-spacing: 0; mso-table-lspace: 0; mso-table-rspace: 0; table-layout: fixed; width: 100%;">
                                                                                                                            <tr>
                                                                                                                                <td class="p1 p1-cta" style="color: #000000; font-family: 'Montserrat-Thin', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; padding-bottom: 20px;">Hello,</td>
                                                                                                                            </tr>
                                                                                                                            <tr>
                                                                                                                                <td class="p1 p1-cta" style="color: #000000; font-family: 'Montserrat-Thin', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; padding-bottom: 15px;">Please find attached the list of leads which were not sent to the CRM from JAWS due to some issue.</td>
                                                                                                                            </tr>
                                                                                                                            <tr>
                                                                                                                                <td class="p1 p1-cta" style="color: #000000; font-family: 'Montserrat-Thin', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; padding-bottom: 5px;">Report has leads captured between: <?php echo $GLOBALS["content"]["emailer"]["fromdate"]; ?> - <?php echo $GLOBALS["content"]["emailer"]["todate"]; ?></td>
                                                                                                                            </tr>
                                                                                                                            <tr>
                                                                                                                                <td class="p1 p1-cta" style="color: #000000; font-family: 'Montserrat-Thin', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; padding-bottom: 15px;">Number of leads failed: <?php echo $GLOBALS["content"]["emailer"]["leadCount"]; ?></td>
                                                                                                                            </tr>
                                                                                                ...
                                                                                                <table border="0" cellpadding="0" cellspacing="0" class="basetable" width="100%" align="left" style="border: none; border-collapse: collapse; border-spacing: 0; mso-table-lspace: 0; mso-table-rspace: 0; width: 100%;">
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td valign="center" style="font-family: 'Montserrat-Thick', Helvetica, Arial, sans-serif; font-size: 12px; color: #FFFFFF;">
                                                                                                            <a href="mailto:info@jigsawacademy.com" style="color: #ffffff; text-decoration: none; ">info@jigsawacademy.com</a>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </td>
