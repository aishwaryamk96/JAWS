						...
						<table border="0" cellpadding="30" cellspacing="0" style="width: 100%; border-color: transparent;" bgcolor="#0c8dc9" color="#ffffff">
							<tr>								
								<td style="text-align: center;">
									<span style="color: white; font-size: 150%;">WNS Nomination</span><br /><br />
									<span style="color: #DAEEF7; font-size: 85%;">Hi <?php echo $GLOBALS["content"]["emailer"]["fname"]; ?>! We wanted to let you that we have received your request to enroll in our course(s).</span>
								</td>
							</tr>
						</table>
					</td>	
				...
				<tr> 
					<td>		
						<table border="0" cellpadding="30" cellspacing="0" style="width: 100%; border-color: transparent;" bgcolor="#f4f6f6" color="#000000">
							<tr>								
								<td style="text-align: center;">
									<span style="color: #252525; font-size: 85%;">Our sales team will get in touch with you shortly (within 24 hrs).<br />Meanwhile if you have any queries, do not hesistate to call us on +91 90192-17000.
									</span>
								</td>
							</tr>
						</table>
