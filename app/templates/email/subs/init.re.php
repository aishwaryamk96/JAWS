                        ...
                        <table border="0" cellpadding="30" cellspacing="0" style="width: 100%; border-color: transparent;" bgcolor="#0c8dc9" color="#ffffff">
                            <tr>
                                <td style="text-align: center;">
                                    <span style="color: white; font-size: 150%;">Resume Your Checkout</span><br /><br />
                                    <span style="color: #DAEEF7; font-size: 85%;">Hi, <?php echo $GLOBALS["content"]["emailer"]["fname"]; ?>! You tried to enroll with us but due to technical reasons the transaction could not be completed. We sincerely apologize for the inconvenience. Please try resuming from where you left. Your selections are listed below.</span>
                                </td>
                            </tr>
                        </table>
                    </td>
