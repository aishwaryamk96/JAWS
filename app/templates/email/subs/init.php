                        ...
                        <table border="0" cellpadding="30" cellspacing="0" style="width: 100%; border-color: transparent;" bgcolor="#0c8dc9" color="#ffffff">
                            <tr>
                                <td style="text-align: center;">
                                    <span style="color: white; font-size: 150%;">Your Enrollment Request</span><br /><br />
                                    <span style="color: #DAEEF7; font-size: 85%;">Hi <?php echo $GLOBALS["content"]["emailer"]["fname"]; ?>! Thank you for choosing to enroll with us!</span>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td>
                        <table border="0" cellpadding="30" cellspacing="0" style="width: 100%; border-color: transparent;" bgcolor="#f4f6f6" color="#000000">
                            <tr>
                                <td style="text-align: center;">
                                    <span style="color: #252525; font-size: 85%;">If you would like to proceed with the payment, please click on the button below and login with your <b>own</b> social ID.</span><br/><br /><br/>
                                    <center>
