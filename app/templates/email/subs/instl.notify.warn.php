                        ...
                        <table border="0" cellpadding="30" cellspacing="0" style="width: 100%; border-color: transparent;" bgcolor="#0c8dc9" color="#ffffff">
                            <tr>                                
                                <td style="text-align: center;">
                                    <span style="color: white; font-size: 150%;">Final Reminder - Installment is Due</span><br /><br />
                                    <span style="color: #DAEEF7; font-size: 85%;">Hi <?php echo $GLOBALS["content"]["emailer"]["fname"]; ?>! We wanted to remind you that your <?php 
                                        ...
                                        ?> installment is due. The sum to be paid for this installment is <?php echo ((strcmp(strtolower($GLOBALS["content"]["emailer"]["currency"]), "inr") == 0) ? '&#8377;' : '&#36;' ).number_format(intval($GLOBALS["content"]["emailer"]["sum"])); ?>. Please make the payment today to continue getting unrestricted access to your course materials. If you have already paid, but have received this email anyways, please inform the Jigsaw support team as soon as possible.</span>
                                </td>
                            </tr>
                        </table>
                    </td>   
                                        ...
                                        <table style="border: 1px solid #e0e1e1;" border="0" cellpadding="0" cellspacing="0">
                                            <tr height="100">
                                                <td width="245" style="text-align: center;">
                                                    ...
                                                    <span style="font-size: 200%; color: #808080;">&#8377;</span>&nbsp;<span style="font-size: 275%; color: black"><?php echo number_format(intval($GLOBALS["content"]["emailer"]["instl"][$count]["sum"])); ?></span>
                                                </td>
                                            </tr>
                                            <tr height="80">
                                                <td width="245">
