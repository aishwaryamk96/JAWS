                        ...
                        <table border="0" cellpadding="30" cellspacing="0" style="width: 100%; border-color: transparent;" bgcolor="#0c8dc9" color="#ffffff">
                            <tr>
                                <td style="text-align: center;">
                                    ...
                                    <span style="color: #DAEEF7; font-size: 85%;">Hi <?php echo $GLOBALS["content"]["emailer"]["fname"]; ?>! Congratulations on your enrollment! We have received your payment of <?php echo ((strcmp(strtolower($GLOBALS["content"]["emailer"]["currency"]), "inr") == 0) ? '&#8377;' : '&#36;' ).number_format(intval($GLOBALS["content"]["emailer"]["sum"])); ?>. You are now successfully enrolled in the courses listed below.</span>
                                </td>
                            </tr>
                        </table>
                    </td>
                                ...
                                ?>
                                    ...
                                    <td bgcolor="#ffffff" width="245" style="">
                                        <table style="border: 1px solid #d8d9d9;" border="0" cellpadding="0" cellspacing="0">
                                            <tr height="122">
                                                <td width="245">
                                                    <a href="<?php echo ($course["status"] == "draft" ? "https://www.jigsawacademy.com/" : $course["url"]); ?>" class="img" style="text-decoration: none;"><img src="<?php echo $course["img"]; ?>" alt="" height="122" width="246" /></a>
                                                </td>
                                            </tr>
                                            <tr height="123">
                                                <td width="245">
                                                    <table style="" border="0" cellpadding="10" cellspacing="0">
                                                        <tr>
                                                            <td>
                                                                <a href="<?php echo ($course["status"] == "draft" ? "https://www.jigsawacademy.com/" : $course["url"]); ?>" class="crs" style="text-decoration: none;"><span style="font-size: 90%; color: #0c8dc9; text-transform: uppercase; line-height: 145%;"><?php echo $course["name"]; ?></span></a><br />
                                                                ...
                                                                <span style="font-size: 55%; color: #FE761B; line-height: 145%; text-transform: uppercase;">*FREE</span><?php */ } ?>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
