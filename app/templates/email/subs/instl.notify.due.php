                        ...
                        <table border="0" cellpadding="30" cellspacing="0" style="width: 100%; border-color: transparent;" bgcolor="#0c8dc9" color="#ffffff">
                            <tr>                                
                                <td style="text-align: center;">
                                    <span style="color: white; font-size: 150%;">Installment is Due</span><br /><br />
                                    <span style="color: #DAEEF7; font-size: 85%;">Hi <?php echo $GLOBALS["content"]["emailer"]["fname"]; ?>! We wanted to let you know that your <?php 
                                        ...
                                        ?> installment is due. The sum to be paid for this installment is <?php echo ((strcmp(strtolower($GLOBALS["content"]["emailer"]["currency"]), "inr") == 0) ? '&#8377;' : '&#36;' ).number_format(intval($GLOBALS["content"]["emailer"]["sum"])); ?>.</span>
                                </td>
                            </tr>
                        </table>
                    </td>   
