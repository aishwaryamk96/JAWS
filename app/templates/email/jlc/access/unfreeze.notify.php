						...
						<table border="0" cellpadding="30" cellspacing="0" style="width: 100%; border-color: transparent;" bgcolor="<?php echo ($GLOBALS["content"]["emailer"]["severity"] ? "#ff0000" : "#0c8dc9") ?>" color="#ffffff">
							<tr>
								<td style="text-align: center;">
									<span style="color: white; font-size: 150%;">Unfreezes for Today</span><br /><br />
								</td>
							</tr>
						</table>
					</td>
							...
							<tr>
								<td style="text-align: left;">
									<span style="color: #252525; font-size: 85%;">
										Please unfreeze the following students today:<br/>
										<?php foreach ($GLOBALS["content"]["emailer"]["students"] as $student) {
											echo $student["email"]." - ".$student["jig_id"]."<br />";
										} ?>
									</span>
								</td>
							</tr>
