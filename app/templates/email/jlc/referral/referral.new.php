                    ...
                    <td width="800" bgcolor="#f4f6f6">
                        <center>
                            ...
                            <table border="0" cellpadding="0" cellspacing="15" bgcolor="#f4f6f6" color="#000000" style="border-color: #e2e4e4; border-style: solid; border-width: 0 0 1px 0;">
                                ...
                                <tr height="20" bgcolor="#f4f6f6">
                                    <td colspan="2">Your friend <?php echo $GLOBALS["content"]["emailer"]["referrer"]["name"]; ?> is learning analytics with us and finds it a great career boost. <?php echo $GLOBALS["content"]["emailer"]["referrer"]["fname"]; ?> has recommended the course<?php echo ($GLOBALS["content"]["emailer"]["courses_count"] > 1 ? "s" : "") ?>, <?php echo $GLOBALS["content"]["emailer"]["courses_str"]; ?> for you as <?php echo ($GLOBALS["content"]["emailer"]["courses_count"] > 1 ? "these are" : "this is") ?> suitable for your profile.</td>
                                </tr>

                                <tr height="20" bgcolor="#f4f6f6">
                                    <?php if ($GLOBALS["content"]["emailer"]["pgpdm"]) { ?>
                                        <td colspan="2">Enroll within the next 14 days </b> as the seats are limited and admissions are closing.</td>
                                    <?php } else { ?>
                                        <td colspan="2">Enroll within the next 30 days using the coupon code <b><?php echo $GLOBALS["content"]["emailer"]["coupon_code"]; ?></b> and get a further discount of 5% on the courses.</td>
                                    <?php } ?>
                                </tr>

                                <tr height="20" bgcolor="#f4f6f6">
                                    <?php if ($GLOBALS["content"]["emailer"]["pgpdm"]) { ?>
                                        <td colspan="2">Please email us at pgpdm@jigsawacademy.com and suggest a suitable time for a counsellor to call you and explain the course details.</td>
                                    <?php } else { ?>
