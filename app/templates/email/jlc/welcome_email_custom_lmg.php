  ...
  <tbody>
   <tr>
	...
	<table width="100%">
		...
		<tr>
			<td style="font-size: 12px; text-align: left; padding: 7px; color: #222222;">
				You are now set up to access the Data Sciences Training at Jigsaw Academy.
			</td>
		</tr>
    	<tr>
        ...
        <tr>
            <td style="font-size: 12px;	text-align: left; padding: 7px;">
                ...
                JLC Email ID : <?php echo $template_content['lab_user']; ?><br/>
		...
		<tr>
			<td style="font-size: 12px;text-align: left; padding: 7px; color: #222222;"><b>Please note:</b> The email ID and password are case-sensitive.</td>
		</tr>
		</tbody>
		<tfoot>
			<tr>
