						...
						<table border="0" cellpadding="30" cellspacing="0" style="width: 100%; border-color: transparent;" bgcolor="#0c8dc9" color="#ffffff">
							<tr>
								<td style="text-align: center;">
									<span style="color: white; font-size: 150%;">You're All Set.</span><br /><br />
									<span style="color: #DAEEF7; font-size: 85%;">Hi <?php echo $GLOBALS["content"]["emailer"]["fname"]; ?>! Thank you for setting up your account access! We now have all the details we needed.</span>
								</td>
							</tr>
						</table>
					</td>
				...
				<tr>
					<td>
						<table border="0" cellpadding="30" cellspacing="0" style="width: 100%; border-color: transparent;" bgcolor="#f4f6f6" color="#000000">
							<tr>
								<td style="text-align: center;">
									<span style="color: #252525; font-size: 85%;">Welcome to the wonderful world of Analytics &amp; Big Data at Jigsaw Academy!<br />
										We require a little time (upto 24hrs) to get your account on the Learning Center ready, and to mail you all the course materials you require. Keep checking your email for the access details - it should be with you very soon!<br /><br/>
