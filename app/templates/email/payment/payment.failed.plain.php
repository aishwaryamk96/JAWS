...
?>
============================..
	JIGSAW ACADEMY - Payment Failed
============================..

Hello <?php echo ucfirst(strtolower($GLOBALS["content"]["emailer"]["fname"])); ?>,

You tried to enroll with us but due to technical reasons the transaction could not be completed. We sincerely apologize for the inconvenience. Please try resuming from where you left.

Your selections are listed below:
