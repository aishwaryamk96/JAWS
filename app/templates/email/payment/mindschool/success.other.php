                ...
                <tr>
                    <td bgcolor="#FFFFFF" valign="bottom" background="https://www.jigsawacademy.com/emailer/images/banner-mage.png" style="-webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover; background-image: url('https://www.jigsawacademy.com/emailer/images/banner-mage.png'); " align="center">
                        ...
                        <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:700px;height:300px;">
                            <v:fill type="tile" src="banner-mage.png" color="#FFFFFF" />
                                                            ...
                                                            <td style="padding-left: 12px; padding-right: 12px;">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                    <![endif]-->
                                                                        <table border="1" bgcolor="#FFCC" cellpadding="5" cellspacing="5" width="100%" align="center" style="background-color: #FFCC; border: 1px solid #e65123; border-collapse: collapse; border-spacing: 1; mso-table-lspace: 0; mso-table-rspace: 0; table-layout: fixed; width: 100%;">
                                                                        <tr>
                                                                            <td>
                                                                            <!--[if (gte mso 9)|(IE)]>
                                                                            <table width="168" align="center" cellpadding="0" cellspacing="0" border="0">
                                                                                ...
                                                                                <tr>
                                                                                    <td style="padding-top:10px;">
                                                                                        <table border="0" cellpadding="0" cellspacing="0" class="basetable" width="100%" align="left" style="border: none; border-collapse: collapse; border-spacing: 0; mso-table-lspace: 0; mso-table-rspace: 0; width: 100%;">
                                                                                            ...
                                                                                            <td valign="center" style="font-family: 'Montserrat-Thick', Helvetica, Arial, sans-serif; font-size: 12px; color: #FFFFFF;"><a href="mailto:know@mind-global.com" style="color: #ffffff; text-decoration: none;">know@mind-global.com</a></td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    </td>
                                                                                </tr>
