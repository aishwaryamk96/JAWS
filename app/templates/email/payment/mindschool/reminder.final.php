                                                                                        ...
                                                                                        <table border="0" cellpadding="0" cellspacing="0" class="basetable" width="100%" align="left" style="border: none; border-collapse: collapse; border-spacing: 0; mso-table-lspace: 0; mso-table-rspace: 0; width: 100%;">
                                                                                            <tr>
                                                                                                ...
                                                                                                <td valign="center" style="font-family: 'Montserrat-Thick', Helvetica, Arial, sans-serif; font-size: 12px; color: #FFFFFF;">
                                                                                                    <a href="mailto:know@mind-global.com" style="color: #ffffff; text-decoration: none; ">know@mind-global.com</a>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    </td>
                                                                            ...
                                                                            <table border="0" cellpadding="0" cellspacing="0" class="basetable" align="left" style="border: none; border-collapse: collapse; border-spacing: 0; max-width: 232px; mso-table-lspace: 0; mso-table-rspace: 0; table-layout: fixed; width: 100%;">
                                                                                <tr>
                                                                                    <td style="padding-top:10px;">
                                                                                        <table border="0" cellpadding="0" cellspacing="0" class="basetable" width="100%" align="left" style="border: none; border-collapse: collapse; border-spacing: 0; mso-table-lspace: 0; mso-table-rspace: 0; width: 100%;">
                                                                                            <tr>
                                                                                                <td valign="bottom" style="font-family: 'Montserrat-Thick', Helvetica, Arial, sans-serif; font-size: 12px; color: #FFFFFF;  padding-top: 7px; text-align: center;">&copy; Manipal Innovation and Design.
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    </td>
