...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    <head>
        ...
        <title>Your Installment Payment is Successful - Jigsaw Academy</title>
    </head>
                                                                ...
                                                                <tr>
                                                                    <td style="padding-left: 12px; padding-right: 12px;">
                                                                        <table border="0" cellpadding="0" cellspacing="0" class="basetable" width="100%" align="center" style="border: none; border-collapse: collapse; border-spacing: 0; mso-table-lspace: 0; mso-table-rspace: 0; table-layout: fixed; width: 100%;">
                                                                            ...
                                                                            <?php $instl_count_text_arr = array( 1 => "first", 2 => "second", 3 => "third", 4 => "fourth", 5 => "fifth", 6 => "sixth", 7 => "seventh", 8 => "eigth", 9 => "ninth" ); ?>
                                                                            <tr>
                                                                                <td class="p1 p1-cta" style="color: #000000; font-family: 'Montserrat-Thin', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px;" align="center">We have received your payment of <b><?php echo ((strcmp(strtolower($GLOBALS["content"]["emailer"]["currency"]), "inr") == 0) ? '&#8377;' : '&#36;' ).number_format(intval($GLOBALS["content"]["emailer"]["sum"])); ?></b> for your <?php echo $instl_count_text_arr[intval($GLOBALS["content"]["emailer"]["instl_count"])]; ?> installment.
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td style="padding-left: 12px; padding-right: 12px;">
                                                                        <table border="0" cellpadding="0" cellspacing="0" class="basetable" width="100%" align="left" style="border: none; border-collapse: collapse; border-spacing: 0; mso-table-lspace: 0; mso-table-rspace: 0; table-layout: fixed; width: 100%;">
                                                                            <tr>
                                                                                <td class="h1" style="color: #000000; font-family: 'Montserrat-Thin', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 17px; padding-bottom: 5px; padding-top: 10px;" align="center">You had opted to finance your enrollment in installments. The following is a summary of the status of your installment scheme. We will email you a reminder of your payment details a week before each due date if any installment is pending.</td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    <td style="padding-left: 12px; padding-right: 12px;">
                                                                        <table border="0" cellpadding="0" cellspacing="0" class="basetable" width="100%" align="left" style="border: none; border-collapse: collapse; border-spacing: 0; mso-table-lspace: 0; mso-table-rspace: 0; table-layout: fixed; width: 100%;">
                                                                            ...
                                                                            <?php } */ ?>
                                                                            <tr>
                                                                                <td class="p1 p1-cta" style="color: #000000; font-family: 'Montserrat-Thin', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 15px; padding-bottom: 20px;" align="center"> Thank you for the payment. </td>
                                                                            </tr>
                                                                            <tr>
                                                                                        ...
                                                                                        <table border="0" cellpadding="0" cellspacing="0" class="basetable" width="100%" align="center" style="border: none; border-collapse: collapse; border-spacing: 0; mso-table-lspace: 0; mso-table-rspace: 0; table-layout: fixed; width: 100%;">
                                                                                            <tr>
                                                                                                <td style="font-family: 'Montserrat-Thick', Helvetica, Arial, sans-serif; font-size: 14px; color: #FFFFFF;">
                                                                                                    ...
                                                                                                    <?php echo $GLOBALS['content']['footer']['phone'] ?? '+91-90199-97000'; ?>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td style="padding-top:10px;">
                                                                                        <table border="0" cellpadding="0" cellspacing="0" class="basetable" width="100%" align="left" style="border: none; border-collapse: collapse; border-spacing: 0; mso-table-lspace: 0; mso-table-rspace: 0; width: 100%;">
                                                                                            ...
                                                                                            <td valign="center" style="font-family: 'Montserrat-Thick', Helvetica, Arial, sans-serif; font-size: 12px; color: #FFFFFF;"><a href="mailto: pgdds@jigsawacademy.com" style="color: #ffffff; text-decoration: none;"> pgdds@jigsawacademy.com</a></td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    </td>
                                                                                </tr>
