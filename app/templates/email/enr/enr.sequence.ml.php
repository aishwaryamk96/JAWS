						...
						<table border="0" cellpadding="30" cellspacing="0" style="width: 100%; border-color: transparent;" bgcolor="<?php echo ($GLOBALS["content"]["emailer"]["severity"] ? "#ff0000" : "#0c8dc9") ?>" color="#ffffff">
							<tr>
								<td style="text-align: center;">
									<span style="color: white; font-size: 150%;"><?php echo $GLOBALS["content"]["emailer"]["header"]; ?></span><br /><br />
								</td>
							</tr>
						</table>
					</td>
							...
							<tr>
								<td style="text-align: left;">
									<span style="color: #252525; font-size: 85%;">
										<?php echo "Enr creation failed because ML duration for course ID ".$GLOBALS["content"]["emailer"]["course_id"]." was not found.".(!empty($GLOBALS["content"]["emailer"]["bundle_id"]) ? " Bundle ID was ".$GLOBALS["content"]["emailer"]["bundle_id"]."." : "").(!empty($GLOBALS["content"]["emailer"]["subs_id"]) ? " Sub ID was ".$GLOBALS["content"]["emailer"]["subs_id"] : "")."."; ?>
									</span>
								</td>
							</tr>
						</table>
