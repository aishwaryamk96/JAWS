...
$(document).ready(function() {
	...
	$("a#btn-dsb").click(function() {
		...
		if ((email.length < 3) || ((email.indexOf('@hsbc.com') == -1) && (email.indexOf('@hsbc.co.in') == -1) && (email.indexOf('@noexternalmail.hsbc.com') == -1) )) {
			$("label.error[for='txt-email']").html("Enter your valid HSBC email ID.");
		...
		window.location.href= $("#txt-jaws-url").val() + "/hsbc/pay?" +
