<?php
    ...
    $ru = $ti['return_url'].(strpos($ti['return_url'], "?") ? "&" : "?")."validate=".$t."&pg=razorpay&ty=neft";
    $states = array(
...
<html lang="en">
    <head>
        ...
        <title>Jigsaw Academy - Payment (NEFT)</title>
                ...
                <div class="ss">
                    <select name="state" id="state">
                        ...
                        <optgroup label="Others">
                            <?php foreach($others as $otherkey => $other){ ?>
                                <?php if( $otherkey == 'outside-india' ) { ?>
                                    <option value="<?php echo $otherkey ?>" selected="selected"><?php echo $other; ?></option>
                                <?php } else { ?>
                                    <option value="<?php echo $otherkey ?>"><?php echo $other; ?></option>
                                <?php } ?>
                            <?php } ?>
                        </optgroup>
                        <?php } */ ?>
                        <optgroup label="States">
                            <?php foreach($states as $statekey => $state){ ?>
                                <?php // if( !empty($us) && $us == $statekey && !$show_outside_india ) { ?>
                        ...
                        <optgroup label="Union Territories">
                            <?php foreach($territories as $territorykey => $territory){ ?>
                                <?php // if( !empty($us) && $us == $territorykey && !$show_outside_india ) { ?>
