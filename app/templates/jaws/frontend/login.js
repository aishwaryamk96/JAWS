...
$(document).ready(function(){	
    ...
    $("span#login-switch-corp").click(function() {
        $(".login-corp").css("display", "inline-block");
        $(".login-soc").css("display", "none");
        $(".page").removeClass('bkg');
    });

    $("span#login-switch-soc").click(function() {
        $(".login-soc").css("display", "block");
        $(".login-corp").css("display", "none");
        $(".page").addClass('bkg');
    });
