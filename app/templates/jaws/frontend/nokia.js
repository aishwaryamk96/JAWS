...
$(document).ready(function() {
	...
	$("a#btn-dsb").click(function() {
		...
		if ((email.length < 3) || ((email.indexOf('@nokia.com') == -1) && (email.indexOf('@nokia.co.in') == -1) )) {
			$("label.error[for='txt-email']").html("Enter your valid Nokia email ID.");
		...
		window.location.href= $("#txt-jaws-url").val() + "/nokia/pay?" +
