...
*/
	...
	// Prep
	$course_name = 'Machine Learning Training Program';
	$course_price = 'INR 33,040';
	...
	ui_render_head_front(array(
		"title" => $course_name." HSBC",
		"scripts" => array(1 => "app/templates/jaws/frontend/hsbc.js"),
		...
		<br/>
			...
			<div id="details" class="border">
				...
				<div class="panel">
					...
					<label for="txt-email" title="Email ID must be under the domain hsbc.com"><i class="fa fa-info-circle fa-lg" title="Email ID must be under the domain hsbc.com"></i>Official Email Id</label>
					<input type="email" id="txt-email" name="email" class="field" value="" placeholder="email@hsbc.com" tabindex="3"/>
