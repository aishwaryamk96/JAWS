...
*/
	...
	$transaction_info['sum'] = 33040; //($_GET['course_code'] == 'fsas' ? 28750 : 42000);
	$transaction_info['currency'] = strtoupper($_GET['paymode']);
	$transaction_info['extra']['desc'] = 'HSBC_ML_INR_2017';
	...
	// Store in Activity
	$act_id = activity_create('high','hsbc.paylink','use','','','','',json_encode($data),'pending');

	// Send Email Here ???

	// Prep more
	$transaction_info['invoice_id'] = $act_id;
	$transaction_info['return_url'] = JAWS_PATH_WEB."/hsbc/pay/success?pay=".$act_id;
	...
	// Transact
	payment_transact($transaction_info, "hsbc.paylink", $act_id, "hsbc.paylink.confirm");
