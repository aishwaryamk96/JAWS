...
<br/>
            ...
            <div id="paymode" class="border">
                    <br/>
                    <form>   
                        <input type="radio" name="opt-mode" value="inr" id="iopt-inr" checked="checked"/><label for="iopt-inr" selected><span><i class="fa fa-fw fa-lg fa-check"></i>   </span>Indian Rupees (34,500 INR Incl. of all taxes)</label><br/>                
                        <!--<input type="radio" name="opt-mode" value="usd" id="iopt-usd"/><label for="iopt-usd"><span><i class="fa fa-fw fa-lg fa-check"></i>   </span>US Dollars (750 USD)</label><br/>-->
            </form>
            </div>
