...
*/
	...
	if (empty($subs_id)) {
        ui_render_msg_front(array(
			...
			"header" => "Oops !",
			"text" => "Sorry, but this link seems to be invalid!<br /><br />Please contact our support team for assistance. (Code: 1-SID)",
    ...
    <script type='text/javascript'>
        ...
        $(document).ready(function(){
            ...
            // API Poll for status
            function poll() {
                $.ajax({url: 'https://www.jigsawacademy.com/jaws/webapi/jlc/enr.ping',type: 'POST',data: {'subs_id' : <?php echo $subs_id; ?>}}).done(function(data) {
                    console.log(data);
                    if(data.status){
                        // ready = true;
        ...
        <form action="https://jigsawacademy.net/login/fskill" name="jlc" method="post">
