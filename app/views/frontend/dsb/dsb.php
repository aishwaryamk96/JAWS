...
*/
	...
	// Prep
	$course_name = 'Tableau and Hadoop & Spark Overview';
	$course_price = 'INR 4,025';
	...
	ui_render_head_front(array(
		"title" => $course_name." (DSB)",
		"scripts" => array(1 => "app/templates/jaws/frontend/dsb.js"),
...
?>
		...
		<div id="wns-form" class="border"> 
			<!--<div style='height: 82px; width: 106px; background-image: url("https://www.jigsawacademy.com/jaws/media/jaws/frontend/images/dsb.gif"); vertical-align: middle; position: absolute; right: 60px;'></div>-->
			<div class="header">Jigsaw Academy</div>
			<div class="sub-header">DSB - <?php echo $course_name; ?></div>
			<div class="intro">
				Enroll for '<?php echo $course_name; ?>' with us and avail an discount exclusive for DSB students. <br/>Fill the form below to enroll yourself.
			</div>
		<br/>
			...
			<div id="details" class="border">
				...
				<div class="panel">
					...
					<label for="txt-email" title="Email ID must be under the domain DSB.edu.in"><i class="fa fa-info-circle fa-lg" title="Email ID must be under the domain DSB.edu.in"></i>DSB Email</label>
					<input type="email" id="txt-email" name="email" class="field" value="" placeholder="email@dsb.edu.in" tabindex="3"/>
