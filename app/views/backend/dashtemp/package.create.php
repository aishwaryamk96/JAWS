...
<html lang="en">
    ...
    <body data-tourian="false">
		...
		<div class="wrapper">
			...
			<div id="main-container">	<!-- SET CLASS to read-only to disable editing -->
				<div class="wrapper">
...
<style>.pymt-sidebar{line-height:16px !important;}.pymt-sidebar input[type="text"]{height:30px;width:auto;}.ovrflw{overflow:unset !important;}.paid{opacity:0.5;filter:blur(2px);}.paid::after{content:"Paid";display:inline-block;font-size:30px;margin:-20px 0 0 30%;}</style>
<?php $confirm_payment_access = true; ?>
	...
	<div class="modal">
		...
		<div class="section-col">
			<?php if(!empty($package['instl']) && $package['instl_total'] > 0 ) {
				...
				<?php } ?>
				<div class="button ripple" style="float:right;" onclick="javascript:updatePaymentDetails($(this));">Update</div>
			<?php } else { ?>
