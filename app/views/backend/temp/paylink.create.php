...
*/
    ...
    // Prep
    $login_params["return_url"] = JAWS_PATH_WEB."/kform";
...
?>
    ...
    <html lang="en">
        <head>
            ...
            <title>Jigsaw Academy - KForm for the KMan!</title>
            ...
            <script>
                $(document).ready(function() {
                    ...
                    $("#commitbtn").click(function() {
                        ...
                        var jaws_webapi_url = $("#txt-jaws-url").val() + "/webapi/temp/paylink.create";
                        var corp = "n";
                        ...
                        $.post(jaws_webapi_url,
                                    ...
                                    function(data, status) {
                                        ...
                                        if (ret) {
                                            ...
                                            window.location.replace($("#txt-jaws-url").val() + "/kform");
                                        }
        ...
        <body>
            ...
            <div>
                <center>
                K-Form for the K-Man! (You are logged in as: <?php echo $_SESSION["user"]["name"]; ?> <a href="<?php echo JAWS_PATH_WEB."/logout"; ?>">Logout</a>)
